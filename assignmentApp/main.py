...
shelfFile = shelve.open("extras/PageDim")

#Opening the blank page
page = Image.open("page_templates/white.jpg")
...
myfont = ImageFont.truetype("fonts/Snake.ttf", 105)

# Open custom text document
with open("textfiles/writing_text.txt", "r") as f:
    text = f.read()
...
for index, letter in enumerate(text):
    try:
        ...
        if((twidth+page_line_space >= page_ver - page_bmar + 50)):
            ...
            copy.save(f'custom/text{page_no}.png')
...
first_image.save(r"documents\assignment.pdf", save_all=True, append_images=image_list)
